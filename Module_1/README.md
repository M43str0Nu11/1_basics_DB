...
- [:thinking: 1.1. Что такое базы данных?](#thinking-11-что-такое-базы-данных)
- [:robot: 1.2. Что такое СУБД?](#robot-12-что-такое-система-управления-базами-данных-субд)
- [:star: 1.3. Виды БД](#star-13-виды-бд)
- [:balance_scale: 1.4. ACID, BASE и CAP](#balance_scale-14-acid-base-и-cap-фундаментальные-компромиссы-распределённых-систем)
- [:knot: 1.5. Связи между таблицами](#knot-15-связи-между-таблицами-реляционная-модель)
